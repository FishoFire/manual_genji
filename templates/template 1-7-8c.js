...
rule ("Match time") {
    ...
    actions {
        ...
        Create HUD Text(All Players(All Teams), Null, Custom String("Server Restarts In {0} Min - V1.7.8c", Global.TimeRemaining, Null, Null), Null, Right, -162, Null, Color(Red), Null, Visible To and String, Visible Always);
