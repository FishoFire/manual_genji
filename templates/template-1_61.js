...
rule ("Setup and Variables") {
    ...
    actions {
        ...
        If(Global.CompMode);
            Create HUD Text(If-Then-Else((Local Player).instructionhud, Local Player, Null), Custom String("                                                                                                                           ", Null, Null, Null), Null, Null, Top, -22, Color(White), Null, Null, Visible To, Default Visibility);
            "replace the instructions custom string for your own instructions. type \\n for enter/next line"
            Create HUD Text(If-Then-Else((Local Player).instructionhud, Local Player, Null), Null, Null, Custom String("${compdescription[0]}", Null, Null, Null), Top, -21, Null, Null, Color(White), Visible To, Default Visibility);
            Create HUD Text(If-Then-Else((Local Player).instructionhud, Local Player, Null), Null, Null, Custom String("${compdescription[1]}", Null, Null, Null), Top, -20, Null, Null, Color(White), Visible To, Default Visibility);
            Create HUD Text(If-Then-Else((Local Player).instructionhud, Local Player, Null), Null, Null, Custom String("${compdescription[2]}", Null, Null, Null), Top, -19, Null, Null, Color(White), Visible To, Default Visibility);
            Create HUD Text(If-Then-Else((Local Player).instructionhud, Local Player, Null), Null, Null, Custom String("${compdescription[3]}", Null, Null, Null), Top, -18, Null, Null, Color(White), Visible To, Default Visibility);
            Create HUD Text(If-Then-Else((Local Player).instructionhud, Local Player, Null), Custom String("                                   Press {0} to start                                ", Input Binding String(Button(Interact)), Null, Null), Null, Null, Top, -17, Color(White), Null, Null, Visible To and String, Default Visibility);
        Else;
        ...
        While(Compare(Global.TimeRemaining, >, 0));
            ...
            If(Global.CompMode);
                ...
                If(Compare(Global.CompTime, ==, 0));
                    ...
                    Set Player Variable(All Players(All Teams), C, 1);
...
rule ("Checkpoint | Arrived") {
    ...
    actions {
        ...
        Play Effect(If-Then-Else(Global.CompMode, Event Player, All Players(All Teams)), Ring Explosion, Color(Sky Blue), Add(Value In Array(Global.A, (Event Player).A), Vector(0, 1.5, 0)), 4);
        ...
        If(Compare((Event Player).PracticeToggle, ==, 1));
            ...
            Skip If(Compare((Event Player).A, <, Subtract(Count Of(Global.A), 1)), 39);
...
rule ("Ms. Destructo | Destroys Breakable Objects On All Maps") {
    ...
    actions {
        ...
        Set Player Variable(Global.MsDestructo, MapVectorArray, Array(Array(0, Map(Hanamura), Map(Hanamura Winter), Map(Horizon Lunar Colony), Map(Paris), Map(Dorado), Map(Havana), Map(Junkertown), Map(Rialto), Map(Route 66), Map(Watchpoint: Gibraltar), Map(Blizzard World), Map(Blizzard World Winter), Map(Eichenwalde), Map(Eichenwalde Halloween), Map(Hollywood), Map(King's Row), Map(King's Row Winter), Map(Ayutthaya), Map(Busan Downtown Lunar New Year), Map(Busan Sanctuary Lunar New Year), Map(Ilios Lighthouse), Map(Ilios Well), Map(Lijiang Control Center), Map(Lijiang Control Center Lunar New Year), Map(Lijiang Garden), Map(Lijiang Garden Lunar New Year), Map(Lijiang Night Market), Map(Lijiang Night Market Lunar New Year), Map(Nepal Sanctum), Map(Nepal Shrine), Map(Nepal Village), Map(Oasis City Center), Map(Oasis Gardens), Map(Oasis University), Map(Black Forest), Map(Black Forest Winter), Map(Castillo), Map(Château Guillard), Map(Château Guillard Halloween), Map(Kanezaka), Map(Petra), Map(Volskaya Industries), Map(Practice Range), Map(Ilios), Map(Busan), Map(Lijiang Tower), Map(Lijiang Tower Lunar New Year), Map(Nepal), Map(Oasis), Map(Malevento)), Array(Vector(15.759, 30.576, -27.201)), Array(Vector(15.759, 30.576, -27.201)), Array(Vector(31.759, 40.003, -59.476)), Array(Vector(-54.508, 40.179, -10.866)), Array(Vector(69.418, 42.103, -17.712)), Array(Vector(9.382, 38.635, -81.276)), Array(Vector(9.382, 38.635, -81.276)), Array(Vector(9.756, 30.753, -41.395)), Array(Vector(30.313, 28.237, -16.925)), Array(Vector(73.985, 26.198, -109.338)), Array(Vector(-21.03, 35.127, 88.381)), Array(Vector(-21.03, 35.127, 88.381)), Array(Vector(54.798, 40.964, -82.78)), Array(Vector(54.798, 40.964, -82.78)), Array(Vector(-0.355, 28.167, -22.396)), Array(Vector(-56.869, 24.061, -32.132)), Array(Vector(-56.869, 24.061, -32.132)), Array(Vector(16.965, 26.541, -7.13)), Array(Vector(51.885, 37.172, -113.654)), Array(Vector(-329.934, 56.136, 149.839)), Array(Vector(322.988, 15.716, -37.732)), Array(Vector(-223.895, 34.756, 0.89)), Array(Vector(-5.808, 324.398, 282.523)), Array(Vector(-5.808, 324.398, 282.523)), Array(Vector(-0.414, 156.197, 148.681)), Array(Vector(-0.414, 156.197, 148.681)), Array(Vector(-0.381, 53.736, -33.335)), Array(Vector(-0.381, 53.736, -33.335)), Array(Vector(83.1, 178.926, 0.593)), Array(Vector(-49.803, 63.29, -0.413)), Array(Vector(-184.659, -38.73, -0.783)), Array(Vector(150.125, 30.619, 251.966)), Array(Vector(134.888, 36.76, -240.736)), Array(Vector(-195.549, 60.35, -0.098)), Array(Vector(-9.622, 44.751, 5.635)), Array(Vector(-9.622, 44.751, 5.635)), Array(Vector(-100.828, 76.566, 60.021)), Array(Vector(200.414, 82.412, 78.813)), Array(Vector(200.414, 82.412, 78.813)), Array(Vector(-36.319, 32.305, 0.472)), Array(Vector(9.678, 28.313, 13.4)), Array(Vector(-49.147, 22.344, 76.844)), Array(Vector(54.948, 50.769, 3.93)), Array(Vector(322.988, 40, -37.732), Vector(27.711, 100, -161.298), Vector(-223.895, 50, 0.89)), Array(Vector(51.885, 37.172, -113.654), Vector(-329.934, 56.136, 149.839), Vector(227.21, 43.353, 252.64)), Array(Vector(-5.808, 324.398, 282.523), Vector(-0.414, 156.197, 148.681), Vector(-0.381, 53.736, -33.335)), Array(Vector(-5.808, 324.398, 282.523), Vector(-0.414, 156.197, 148.681), Vector(-0.381, 53.736, -33.335)), Array(Vector(83.1, 178.926, 0.593), Vector(-49.803, 63.29, -0.413), Vector(-184.659, -38.73, -0.783)), Array(Vector(150.125, 30.619, 251.966), Vector(134.888, 36.76, -240.736), Vector(-195.549, 60.35, -0.098)), Array(Vector(17.808, 35.955, 17.505))));
