...
document.getElementById("versiondisplayhere").innerHTML = "1.8.1b"
...
settings
{
	main
	{
		...
		Mode Name: "Genji Parkour - 源氏跑酷 - v1.8.1b"
	}
...
rule("Huds: Global/Localplayer")
{
	...
	actions
	{
		...
		Create HUD Text(All Players(All Teams), Null, String("Capture") == Custom String("捕捉") || Custom String("{0}", Color(Rose))
			== Custom String("玫红") ? Custom String("房间将在 {0} 分钟后重启 - V{1}", Global.TimeRemaining, Custom String("1.8.1b")) : Custom String(
			"Server Restarts In {0} Min - V{1}", Global.TimeRemaining, Custom String("1.8.1b")), Null, Right, -161, Null, Color(Red), Null,
