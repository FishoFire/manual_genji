...
settings
{
	main
	{
		...
		Mode Name: "Genji Parkour v1.7.4"
	}
	lobby
	{
...
${faketripleon}rule ("Addon | Fake Triple Jump") {
    event {
        Ongoing - Each Player;
        All;
        Genji;
