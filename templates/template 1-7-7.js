...
settings
{
	main
	{
		...
		Mode Name: "Genji Parkour v1.7.7"
	}
	lobby
	{
...
rule ("Match time") {
    ...
    actions {
        ...
        Create HUD Text(All Players(All Teams), Null, Custom String("Server Restarts In {0} Min - V1.7.7", Global.TimeRemaining, Null, Null), Null, Right, -162, Null, Color(Red), Null, Visible To and String, Visible Always);
