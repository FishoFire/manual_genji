...
settings
{
	main
	{
		...
		Mode Name: "Genji Parkour v1.7.6"
	}
	lobby
	{
...
rule ("Match time") {
    ...
    actions {
        ...
        Create HUD Text(All Players(All Teams), Null, Custom String("Server Restarts In {0} Min - V1.7.6", Global.TimeRemaining, Null, Null), Null, Right, -162, Null, Color(Red), Null, Visible To and String, Visible Always);
...
rule ("Ms. Destructo | Destroys Breakable Objects On All Maps") {
    ...
    actions {
        ...
        If(True);
        Skip(Value In Array(Array(12, 0, 2, 4, 6, 8, 10), Add(1, Index Of Array Value(Array(Map(Ilios), Map(Busan), Map(Lijiang Tower), Map(Nepal), Map(Oasis), Map(New Queen Street)), Current Map))));
