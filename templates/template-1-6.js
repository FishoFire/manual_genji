...
rule ("Setup and Variables") {
    ...
    actions {
        ...
        If(Global.CompMode);
            Create HUD Text(All Players(All Teams), Null, Null, If-Then-Else(Compare(Global.CompTime, >, 0), Custom String("competitive mode", Null, Null, Null), Custom String("competitive mode\n\n\n", Null, Null, Null)), Top, -850, Color(Yellow), If-Then-Else(And(Compare((Local Player).AttemptCount, ==, -1), Compare(Global.CompAtmpNum, >, 0)), Color(Red), Color(Yellow)), Color(Yellow), Visible To String and Color, Default Visibility);
        Else;
    ...
    actions {
        ...
        If(Global.CompMode);
            ...
            If(Not(Array Contains(Global.CompAtmpSaveNames, Custom String("{0}", Event Player, Null, Null))));
                ...
                Create HUD Text(Event Player, Custom String("                                                                                                                           ", Null, Null, Null), Null, Null, Top, -21, Color(White), Null, Null, None, Default Visibility);
                Set Player Variable At Index(Event Player, instructionhud, 0, Last Text ID);
                "replace the instructions custom string for your own instructions. type \\n for enter/next line"
                Create HUD Text(Event Player, Null, Custom String("\n(instructions here, find this with control + F in notepad and replace the text. use \n for new lines)\n", Null, Null, Null), Null, Top, -20, Color(Orange), Color(White), Color(White), String, Default Visibility);
                Set Player Variable At Index(Event Player, instructionhud, 1, Last Text ID);
                Create HUD Text(Event Player, Custom String("                                   Press {0} to start                                ", Button(Interact), Null, Null), Null, Null, Top, -19, Color(White), Null, Null, None, Default Visibility);
                Set Player Variable At Index(Event Player, instructionhud, 2, Last Text ID);
                ...
                Destroy HUD Text(First Of((Event Player).instructionhud));
                Destroy HUD Text(Value In Array((Event Player).instructionhud, 1));
                Destroy HUD Text(Value In Array((Event Player).instructionhud, 2));
                Create HUD Text(Event Player, Null, If-Then-Else(Compare(Global.CompTime, <=, 0), Custom String("!competition is over!", Null, Null, Null), Custom String("time left: {0} min{1}", Global.CompTime, If-Then-Else(Compare((Event Player).AttemptCount, ==, -1), Custom String("\nYou are out of attemps", Null, Null, Null), If-Then-Else(Compare(Global.CompAtmpNum, >, 0), Custom String("\nAttempt {0} / {1}", (Event Player).AttemptCount, Global.CompAtmpNum, Null), Custom String("", Null, Null, Null))), Null)), Null, Top, -860, Null, Color(Yellow), Null, String, Default Visibility);
            Else;
...
rule ("Tittle ") {
    ...
    actions {
        ...
        Create In-World Text(All Players(All Teams), Value In Array(Value In Array(Global.TitleData, 1), Index Of Array Value(First Of(Global.TitleData), (Event Player).A)), Event Player, 1.1, Clip Against Surfaces, Visible To and Position, Value In Array(Value In Array(Global.TitleData, 2), Index Of Array Value(First Of(Global.TitleData), (Event Player).A)), Default Visibility);
...
rule ("Checkpoint | Arrived") {
    ...
    actions {
        ...
        If(Compare((Event Player).PracticeToggle, ==, 1));
            ...
            Skip If(Compare((Event Player).A, <, Subtract(Count Of(Global.A), 1)), 38);
