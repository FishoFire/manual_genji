...
rule ("Credits here <---- INSERT YOUR NAME HERE") {
    ...
    actions {
        "NOHUDTAG"
        Create In-World Text(Local Player, Custom String("crouch + {0} + {1}: full restart\n{2}", Input Binding String(Button(Ability 2)), Input Binding String(Button(Interact)), Custom String("{0} + {1}: invincible\n{2}", Input Binding String(Button(Reload)), Input Binding String(Button(Melee)), Custom String("{0}: quick reset\n{1}(hold): spectate\n{2}", Input Binding String(Button(Reload)), Input Binding String(Button(Interact)), Custom String("{0} + {1}: practice mode", Input Binding String(Button(Ultimate)), Input Binding String(Button(Melee)), Null)))), Update Every Frame(Subtract(Add(Add(Eye Position(Local Player), Multiply(200, Facing Direction Of(Local Player))), Multiply(127, Cross Product(Facing Direction Of(Local Player), World Vector Of(Multiply(Left, 0.65), Local Player, Rotation)))), Multiply(208, World Vector Of(Multiply(Left, 0.9), Local Player, Rotation)))), 1.3, Do Not Clip, Visible To Position and String, Color(White), Default Visibility);
        Create In-World Text(Local Player, Custom String("Map by: ${mapmaker} \nCode: ${mapcode}\nDiscord:dsc.gg/genjiparkour", Null, Null, Null), Update Every Frame(Add(Add(Add(Eye Position(Local Player), Multiply(200, Facing Direction Of(Local Player))), Multiply(131, Cross Product(Facing Direction Of(Local Player), World Vector Of(Multiply(Left, 0.65), Local Player, Rotation)))), Multiply(206, World Vector Of(Multiply(Left, 0.9), Local Player, Rotation)))), 1.3, Do Not Clip, Visible To and Position, Color(Purple), Default Visibility);
        Create In-World Text(Local Player, Custom String("Level: {0} / {1}\nTime: {2}", (Local Player).A, Subtract(Count Of(Global.A), 1), (Local Player).D), Update Every Frame(Add(Add(Eye Position(Local Player), Multiply(200, Facing Direction Of(Local Player))), Multiply(124, Cross Product(Facing Direction Of(Local Player), World Vector Of(Multiply(Left, 0.9), Local Player, Rotation))))), 1.4, Do Not Clip, Visible To Position and String, Color(White), Default Visibility);
    }
}
...
rule ("HUD | Guide") {
    ...
    actions {
        ...
        Create HUD Text(Host Player, Custom String("{0}\norb/portal limit: {1}/{2}", If-Then-Else(Compare((Host Player).E, ==, 1), Custom String("Checkpoint Mode", Null, Null, Null), If-Then-Else(Compare((Host Player).E, ==, 2), Custom String("Current Kill Orb's radius: {0}", Value In Array(Global.I, Value In Array((Host Player).KillIndex_Cache, Global.J)), Null, Null), If-Then-Else(Compare((Host Player).E, ==, 3), Custom String("Current Bounce Orb's strength: {0}", Value In Array(Global.EditMode, Value In Array((Host Player).BounceIndex_Cache, Global.TQ1)), Null, Null), Custom String("", Null, Null, Null)))), Add(Add(Count Of(Global.TQ), Count Of(Global.H)), Count Of(Global.CustomPortalStart)), 193), Null, Null, Top, -20, Color(Red), Color(Orange), Color(Orange), Visible To and String, Default Visibility);
    }
}
...
rule ("Setup and Variables") {
    ...
    actions {
        ...
        Create HUD Text(If-Then-Else(Compare((Host Player).E, <, 1), All Players(All Teams), Null), Null, Null, Custom String("Hold {0} | leaderboard", Input Binding String(Button(Melee)), Null, Null), Right, -17, Null, Null, Color(White), Visible To and String, Default Visibility);
...
rule ("Initialize and CP HUD") {
    ...
    actions {
        Create HUD Text(Event Player, Null, Null, Custom String("{0} {1}", Custom String("Level ", Null, Null, Null), Custom String("{0} / {1}", (Event Player).A, Subtract(Count Of(Global.A), 1), Null), Null), Top, -14, Null, Null, Color(White), Visible To and String, Default Visibility);
        Create HUD Text(Array(If-Then-Else(Compare(Count Of(Filtered Array(Global.TQ, And(Compare(Value In Array(Global.pinballnumber, Index Of Array Value(Global.TQ, Current Array Element)), ==, (Event Player).A), Compare(Value In Array(Global.BounceToggleLock, Index Of Array Value(Global.TQ, Current Array Element)), ==, True)))), >, 0), Event Player, Null)), Null, Null, Custom String("{0} / {1} orange orbs", If-Then-Else(Compare((Event Player).LockCollected, ==, 0), Custom String("0", Null, Null, Null), Subtract(Count Of((Event Player).LockCollected), 1)), Count Of(Filtered Array(Global.TQ, And(Compare(Value In Array(Global.pinballnumber, Index Of Array Value(Global.TQ, Current Array Element)), ==, (Event Player).A), Compare(Value In Array(Global.BounceToggleLock, Index Of Array Value(Global.TQ, Current Array Element)), ==, True)))), Null), Top, -13, Null, Null, Color(White), Visible To and String, Default Visibility);
        "LEFT, -2"
        ...
        Set Player Variable(Event Player, EditorOn, Workshop Setting Toggle(Custom String("Editor", Null, Null, Null), Custom String("Editor mode", Null, Null, Null), False, 0));
...
rule ("SUB | Checkpoint Fail") {
    ...
    actions {
        Set Player Variable(Event Player, LockCollected, Null);
...
rule ("Checkpoint | Arrived") {
    ...
    actions {
        ...
        If(Compare(Count Of(Filtered Array(Global.TQ, And(Compare(Value In Array(Global.pinballnumber, Index Of Array Value(Global.TQ, Current Array Element)), ==, (Event Player).A), Compare(Value In Array(Global.BounceToggleLock, Index Of Array Value(Global.TQ, Current Array Element)), ==, True)))), >, 0));
            If(Compare(Count Of(Filtered Array(Global.TQ, And(And(Compare(Value In Array(Global.pinballnumber, Index Of Array Value(Global.TQ, Current Array Element)), ==, (Event Player).A), Compare(Value In Array(Global.BounceToggleLock, Index Of Array Value(Global.TQ, Current Array Element)), ==, True)), Array Contains((Event Player).LockCollected, Current Array Element)))), <, Count Of(Filtered Array(Global.TQ, And(Compare(Value In Array(Global.pinballnumber, Index Of Array Value(Global.TQ, Current Array Element)), ==, (Event Player).A), Compare(Value In Array(Global.BounceToggleLock, Index Of Array Value(Global.TQ, Current Array Element)), ==, True))))));
        ...
        If(Compare((Event Player).PracticeToggle, ==, 1));
            Modify Player Variable(Event Player, PracticeCheckpoint, Add, 1);
            Skip If(Compare((Event Player).A, <, Subtract(Count Of(Global.A), 1)), 27);
...
rule ("Combo | Quick Reset | Rel﻿oad, Hold Rel﻿oad to Enable") {
    ...
    actions {
        ...
        If(Compare((Event Player).quick_restart, ==, True));
            Set Player Variable(Event Player, LockCollected, 0);
            If(Is Using Ultimate(Event Player));
                Kill(Event Player, Null);
            End;
            Start Forcing Player Position(Event Player, If-Then-Else(Compare(Count Of(Value In Array(Global.A, (Event Player).A)), !=, 0), Value In Array(Value In Array(Global.A, (Event Player).A), 1), Value In Array(Global.A, (Event Player).A)), True);
...
rule ("HUD | Wallclimb Used") {
    ...
    actions {
        ...
        "NOHUDTAG"
        Small Message(Event Player, Custom String("climbed", Null, Null, Null));
        Set Player Variable(Event Player, paqiang, Last Text ID);
    }
}
...
rule ("Ban | Triple Jump") {
    ...
    conditions {
        Workshop Setting Toggle(Custom String("Ban Switch", Null, Null, Null), Custom String("Ban Triple Jump", Null, Null, Null), False, 0) == True;
        (Event Player).C == 0;
        (Event Player).A < Subtract(Count Of(Global.A), 1);
...
rule ("Ban | Multiclimb") {
    ...
    conditions {
        Workshop Setting Toggle(Custom String("Ban Switch", Null, Null, Null), Custom String("Ban Multiclimb", Null, Null, Null), False, 1) == True;
        (Event Player).C == 0;
        (Event Player).A < Subtract(Count Of(Global.A), 1);
...
rule ("Ban | Emote Savehop") {
    ...
    conditions {
        Workshop Setting Toggle(Custom String("Ban Switch", Null, Null, Null), Custom String("Ban Emote Savehop", Null, Null, Null), False, 3) == True;
        (Event Player).C == 0;
        (Event Player).A < Subtract(Count Of(Global.A), 1);
        Is Communicating Any Emote(Event Player) == True;
    }
...
rule ("Ban | Create Bhop") {
    ...
    actions {
        Wait(1, Ignore Condition);
        Set Global Variable(kaxiaotiao, Workshop Setting Toggle(Custom String("Ban Switch", Null, Null, Null), Custom String("Ban Create Bhop", Null, Null, Null), False, 2));
    }
}
...
rule ("Ban | Deathbhop") {
    ...
    actions {
        Wait(1, Ignore Condition);
        Set Global Variable(deathjump, Workshop Setting Toggle(Custom String("Ban Switch", Null, Null, Null), Custom String("Ban Deathbhop", Null, Null, Null), False, 4));
    }
}
...
rule ("Ban | Dash Start") {
    ...
    actions {
        Wait(1, Ignore Condition);
        Set Global Variable(DashExploitToggle, Workshop Setting Toggle(Custom String("Ban Switch", Null, Null, Null), Custom String("Ban Dash Start", Null, Null, Null), False, 4));
    }
}
